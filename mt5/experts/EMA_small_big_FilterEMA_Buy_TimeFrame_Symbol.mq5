...
#property strict
#property description "Buy-only EMA cross EA with configurable filter EMA for any symbol and timeframe."
...
int OnInit()
{
   ...
   g_ema200_handle = iMA(_Symbol, g_strategy_timeframe, InpFilterEmaPeriod, 0, MODE_EMA, PRICE_CLOSE);
