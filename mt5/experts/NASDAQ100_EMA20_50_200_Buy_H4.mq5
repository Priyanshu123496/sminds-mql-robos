...
#property strict
#property description "Buy-only EMA 20/50 cross EA with EMA 200 trend filter for NASDAQ100 H4."
...
const string STRATEGY_SYMBOL = "NASDAQ100";
const ulong STRATEGY_MAGIC = 26022504;
