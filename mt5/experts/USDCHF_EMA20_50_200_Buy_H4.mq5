...
#property strict
#property description "Buy-only EMA 20/50 cross EA with EMA 200 trend filter for USDCHF H4."
...
const string STRATEGY_SYMBOL = "USDCHF";
const ulong STRATEGY_MAGIC = 26022506;
