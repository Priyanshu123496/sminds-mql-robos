...
#property strict
#property description "Buy-only EMA 20/50 cross EA with EMA 200 trend filter for EURUSD H4."
...
const string STRATEGY_SYMBOL = "EURUSD";
const ulong STRATEGY_MAGIC = 26022507;
