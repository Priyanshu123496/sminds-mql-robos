...
#property strict
#property description "Buy-only EMA 20/50 cross EA with EMA 200 trend filter for GBPUSD H4."
...
const string STRATEGY_SYMBOL = "GBPUSD";
const ulong STRATEGY_MAGIC = 26022508;
