...
#property strict
#property description "Buy-only EMA 9/15 cross EA with EMA 200 trend filter for XAUUSD H4."

#include <Trade/Trade.mqh>

input double InpLotSize = 1.0;

const int FAST_EMA_PERIOD = 9;
const int SLOW_EMA_PERIOD = 15;
const int FILTER_EMA_PERIOD = 200;
const ENUM_TIMEFRAMES STRATEGY_TIMEFRAME = PERIOD_H4;
const string STRATEGY_SYMBOL = "XAUUSD";
...
void OnTick()
{
   ...
   if(!g_trade.Buy(volume, STRATEGY_SYMBOL, 0.0, 0.0, 0.0, "EMA9x15 Buy"))
   {
