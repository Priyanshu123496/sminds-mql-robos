...
#property strict
#property description "Buy-only EMA 20/50 cross EA with EMA 200 trend filter for US30 H4."
...
const string STRATEGY_SYMBOL = "US30";
const ulong STRATEGY_MAGIC = 26022503;
